...
pub struct Board {
    pub nodes: [[&Node; BOARD_SIZE]; BOARD_SIZE],
    pub arr_board [[u8; BOARD_SIZE]; BOARD_SIZE]
}

pub struct Node {
    pub possibles: [u8; BOARD_SIZE],
    pub row: [&Node; BOARD_SIZE],
    pub col: [&Node; BOARD_SIZE],
    pub sqr: [&Node; BOARD_SIZE],
    pub solved: bool
}

impl Node {
    pub fn new() -> Node {
        let possibles = [u8:BOARD_SIZE];
